...
public class CategoryTestCase {
	 ...
	 * 
	 * category.setDescription("This descrition is for television");
	...
	/*
	 * @Test public void testAddCategory() { category=categoryDAO.get(3);
...
/*	
	...
	public void testListCategory() {
		assertEquals("Successfully fetched the list of category inside the table", 3, categoryDAO.list().size());
	...
	*/
	...
	public void testCRUD() {
		...
		category = new Category();
		 ...
		 category.setDescription("This descrition is for laptop");
		 category.setImageURL("CAT_1.png");
